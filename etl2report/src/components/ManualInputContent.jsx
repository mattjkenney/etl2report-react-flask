...
export default function ManualInputContent({ id, index, templateName }) {
    ...
    useEffect(() => {
        dispatch(initializeItem({ sectionId: 'manuals', templateId: templateName, itemId: id }));
    ...
    const updateInputField = (field, value) => {
        dispatch(updateField({ sectionId: 'manuals', templateId: templateName, itemId: id, field, value }));
    };
